...
namespace Rubiks
{
	...
	public:
		...
		static bool TableFileLoad(char const * const fileName, std::vector<char>& map);
	...
	private :
		...
		unsigned long long GetCornerHash() const;
		...
		unsigned long long GetEdgeHash(bool const setA) const;
